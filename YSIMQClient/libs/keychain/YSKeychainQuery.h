...
NS_ASSUME_NONNULL_BEGIN
	...
	#define YSKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define YSKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef YSKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, YSKeychainQuerySynchronizationMode) {
	YSKeychainQuerySynchronizationModeAny,
	YSKeychainQuerySynchronizationModeNo,
	YSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface YSKeychainQuery : NSObject
...
@property (nonatomic) YSKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 YSKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
