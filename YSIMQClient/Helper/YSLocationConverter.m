//
//  YSLocationConverter.m
//  YSCLLocationMangerDome
//
...
// YSA = 6378245.0, 1/f = 298.3
// b = a * (1 - f)
// ee = (a^2 - b^2) / a^2;
#define YSA 6378245.0
#define YSEE 0.00669342162296594323



@implementation YSLocationConverter
...
+ (CLLocationCoordinate2D)gcj02Encrypt:(double)ggLat bdLon:(double)ggLon
{
    ...
    magic = 1 - YSEE * magic * magic;
    double sqrtMagic = sqrt(magic);
    dLat = (dLat * 180.0) / ((YSA * (1 - YSEE)) / (magic * sqrtMagic) * M_PI);
    dLon = (dLon * 180.0) / (YSA / sqrtMagic * cos(radLat) * M_PI);
    mgLat = ggLat + dLat;
    mgLon = ggLon + dLon;
